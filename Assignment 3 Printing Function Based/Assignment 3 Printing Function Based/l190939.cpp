...
// This function will help you print at any x and y on the screen.
// x and y are cartesian coordinates just like maths.
...
public:
	...
	void addLabel() {
		...
		arr.push_back(newLabel);

	}

	void addTextField() {

		Component* newTextField = new TextField;

		arr.push_back(newTextField);

	}

	void printWindowOutline() {
